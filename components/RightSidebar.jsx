  ...
  return (
    <>
      <motion.div 
        ...
        className="hidden lg:flex flex-col items-center fixed bottom-0 right-4 lg:right-8 w-10 z-40"
      >
        <div className="flex flex-col items-center space-y-6">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="h-6 w-6" viewBox="0 0 16 16">
