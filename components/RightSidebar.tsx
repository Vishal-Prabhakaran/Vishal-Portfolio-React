    ...
    <div className="hidden md:flex flex-col items-center fixed bottom-0 right-12 w-10 z-10">
      <div className="flex flex-col items-center space-y-6">
        ...
        <a
          ...
          className="text-dark-text-secondary hover:text-[#D14836] transition-all duration-300 hover:-translate-y-1"
          aria-label="Email"
        >
          <svg
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="WhatsApp"
          className="text-dark-text-secondary hover:text-[#25D366] transition-all duration-300 hover:-translate-y-1"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
